        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800">
              ...
              <p className="text-sm text-zinc-500 mb-4">For content creators</p>
              <div className="mb-6">
            ...
            {/* Pro */}
            <div className="p-6 rounded-2xl bg-zinc-900 border-2 border-emerald-500/50 relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-emerald-500 text-white text-xs font-medium rounded-full">
                Most Popular
              </div>
              <h3 className="text-lg font-semibold text-white mb-1">Pro</h3>
              <p className="text-sm text-zinc-500 mb-4">For teams & agencies</p>
              <div className="mb-6">
            ...
            <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-semibold text-white mb-1">Pro+</h3>
              <p className="text-sm text-zinc-500 mb-4">For serious agencies</p>
              <div className="mb-6">
