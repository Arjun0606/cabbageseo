-- ============================================
-- CabbageSEO COMPLETE Database Schema + Storage + Notifications
-- Copy and paste this entire script into Supabase SQL Editor
-- Version 2 - Includes notifications table
-- ============================================
...
-- Exports bucket (articles, reports, CSVs)
...
-- Uploads bucket (user file uploads)
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
...
-- Content images policies (public read)
...
-- ============================================
-- DONE! CabbageSEO database + storage + notifications is ready.
-- Total: 23 tables, 5 storage buckets
-- ============================================
