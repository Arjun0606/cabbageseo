-- ============================================
-- CabbageSEO LAUNCH SCHEMA - COMPLETE
-- Based on V3 + Production Updates
-- Run ONCE in Supabase SQL Editor
-- ============================================

-- ============================================
-- STEP 0: CLEAN ALL DATA (Fresh Start)
-- ============================================
...
-- ============================================
-- PART 2: ENUMS (Updated for GEO + more CMS)
-- ============================================
...
-- ============================================
-- PART 3: CORE TABLES (Dodo Payments ready)
-- ============================================
...
-- ============================================
-- PART 4: SITE TABLES (GEO fields added)
-- ============================================
...
-- ============================================
-- PART 8: INDEXES (ALL from V3 + extras)
-- ============================================
...
-- ============================================
-- PART 9: TRIGGERS & FUNCTIONS (ALL from V3)
-- ============================================
...
-- ============================================
-- PART 10: ROW LEVEL SECURITY (ALL from V3)
-- ============================================
...
-- ============================================
-- PART 13: STORAGE POLICIES (ALL 18 from V3)
-- ============================================
...
-- ============================================
-- ✅ LAUNCH READY! CabbageSEO Production V4
-- 24 tables, 5 storage buckets, 18 storage policies
-- Includes: Dodo Payments, GEO fields, all V3 features
