  ...
  const plans = [
    {
      ...
      price: 0,
      period: "forever",
      description: "One-time manual check to see what AI recommends in your market. No ongoing monitoring.",
      cta: "Run Free Check",
      ctaVariant: "outline" as const,
      features: [
        { name: "1 site", included: true },
        { name: "3 manual checks/day", included: true },
        { name: "See who AI recommends", included: true },
        { name: "View raw AI responses", included: true },
        { name: "Daily/Hourly monitoring", included: false },
        { name: "Content fix generator", included: false },
        { name: "Competitor alerts", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Competitor takeover alerts", included: true },
        { name: "Weekly action playbook", included: true },
      ],
      popular: true,
    },
  ];
