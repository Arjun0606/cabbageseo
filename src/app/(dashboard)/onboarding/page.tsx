            ...
            <form onSubmit={handleDomainSubmit} className="space-y-4">
              ...
              <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-3.5 flex items-start gap-3">
                ...
                <p className="text-xs text-zinc-400">
                  <span className="font-medium text-amber-300">One site per billing period.</span>{" "}
                  Your {planName} plan tracks one site at a time. You won&rsquo;t be able to switch until your next billing period.
                </p>
              </div>
