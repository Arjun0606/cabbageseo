...
function FreeScoringPageContent() {
  ...
  // Generate AI-friendly export for Cursor/Claude
...
*Paste this into Cursor, Claude, or your AI coding assistant to implement fixes.*
`;
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="mb-6 flex justify-between items-center">
              <div className="flex gap-2">
                ...
                >
                  {exportCopied ? <Check className="w-4 h-4 mr-2" /> : <FileText className="w-4 h-4 mr-2" />}
                  {exportCopied ? "Copied for AI!" : "Export for Cursor/Claude"}
                </Button>
              </div>
              <Button
                variant="outline"
