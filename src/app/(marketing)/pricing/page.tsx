...
export default function PricingPage() {
  const plans = [
    ...
    },
    {
      ...
      price: 29,
      period: "/month",
      description: "Daily automated checks + unlimited manual checks. 30-day history.",
      cta: "Get Starter",
      ctaVariant: "outline" as const,
      features: [
        { name: "3 sites", included: true },
        { name: "Unlimited manual checks", included: true },
    ...
    },
    {
      ...
      price: 79,
      period: "/month",
      description: "Hourly automated checks + unlimited manual checks. 1-year history.",
      cta: "Get Pro",
