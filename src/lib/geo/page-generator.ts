...
3. ${isComparisonQuery ? "COMPARISON TABLE: Include a detailed markdown table comparing the top options. Columns should include real features, actual pricing, and honest pros/cons. AI models extract these tables directly." : isHowToQuery ? "STEP-BY-STEP: Use numbered steps with clear, actionable instructions. Each step should have a specific outcome. Include common pitfalls or tips." : "STRUCTURED SECTIONS: Use clear H2/H3 hierarchy. Each section should contain at least one quotable, self-contained fact that AI can cite independently."}
