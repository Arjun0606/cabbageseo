...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cabbage-500 focus-visible:ring-offset-2",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cabbage-500 focus-visible:ring-offset-2",
