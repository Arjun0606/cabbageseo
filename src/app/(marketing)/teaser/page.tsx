...
function TeaserContent() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="max-w-md w-full mx-auto px-6 text-center">
          <GlassCard hover={false} glow="red" padding="lg">
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center gap-3 mb-4">
                <button
                  onClick={handleTweet}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white/[0.06] hover:bg-white/[0.1] border border-white/[0.06] text-white text-sm rounded-lg transition-colors"
                >
                    ...
                    {result.aiRecommends.length > 0 && (
                      <div className="flex flex-wrap gap-1.5">
                        {result.aiRecommends.slice(0, 6).map((competitor, j) => (
                          <span
                            key={j}
                            className="px-2 py-1 bg-white/[0.06] text-zinc-400 rounded text-xs"
                          >
                            {competitor}
                          </span>
                        ))}
        ...
        {/* ========== 30-DAY FIX SECTION ========== */}
        <AnimateIn delay={0.2}>
          <GlassCard hover={false} glow="emerald" padding="lg" className="mb-8 !border-emerald-500/20">
            <div className="text-center mb-6">
            ...
            <div className="space-y-3 mb-6">
              {fixBullets.map((bullet, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 p-4 bg-white/[0.04] border border-white/[0.06] rounded-xl"
                >
        ...
        <AnimateIn delay={0.25}>
          <div className="relative overflow-hidden rounded-2xl p-8 border border-emerald-500/20">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="flex items-start gap-3 p-4 bg-white/[0.04] border border-white/[0.06] rounded-xl">
